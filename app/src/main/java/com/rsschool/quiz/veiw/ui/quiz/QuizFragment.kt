...
class QuizFragment() : Fragment() {
    ...
    private var onQuizListener: QuizButtonsListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        val callback: OnBackPressedCallback = object : OnBackPressedCallback(
            ...
            override fun handleOnBackPressed() {
                onQuizListener?.onBackButtonListener(getSelectedRadioButton(currentPage))
            }
        }
        if (currentPage != 0) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextButton.setOnClickListener {
            onQuizListener?.onNextButtonListener(getSelectedRadioButton(currentPage),
    ...
    fun setQuizListener(buttonsListener: QuizButtonsListener) {
        onQuizListener = buttonsListener
    }
