...
class ResultFragment : Fragment() {
    ...
    private var onResultButtonsListener: ResultButtonsListener? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.startOverButton.setOnClickListener {
            onResultButtonsListener?.onStartOverButtonListener()
        }
    ...
    fun setStartOverButtonListener(listener: ResultButtonsListener) {
